...
const ADMIN_EMAIL = config.demoEmail;
const ADMIN_PASSWORD = config.demoPassword;
const CURRENCY = config.demoCurrency;
const TIMEZONE = config.demoTimezone;
...
const DORM_ROOMS = config.demoDormRooms;
const DORM_BEDS_PER_ROOM = config.demoDormBedsPerRoom;
const HISTORY_DAYS = config.demoHistoryDays;
...
async function main() {
  ...
  // ── Team ──────────────────────────────────────────────────
  const staff = [
    { name: 'Nadeeka Silva', email: 'nadeeka@mellowbay.com', role: 'front_office', password: ADMIN_PASSWORD },
    { name: 'Sunil Perera', email: 'sunil@mellowbay.com', role: 'housekeeping', password: ADMIN_PASSWORD },
    { name: 'Chamari Gunawardena', email: 'chamari@mellowbay.com', role: 'accounts', password: ADMIN_PASSWORD },
    { name: 'Roshan De Silva', email: 'roshan@mellowbay.com', role: 'revenue', password: ADMIN_PASSWORD },
  ];
