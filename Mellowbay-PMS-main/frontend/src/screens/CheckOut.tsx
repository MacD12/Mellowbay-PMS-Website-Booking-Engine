...
export function CheckOutScreen({ reservationId }: { reservationId?: string }) {
  ...
  const settleTotal = paymentTotals(draft, methodRow, surchargeOn, defaultBp).totalMinor;
  const canSettle = paymentReady(draft, methodRow, surchargeOn, defaultBp);
